						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-dark " type="button" onclick="location.href='billing/index.php?id=<?php echo $row['id'] ?>'" data-id="<?php echo $row['id'] ?>" >Edit</button>
										<button class="btn btn-sm btn-outline-dark view_order" type="button" data-id="<?php echo $row['id'] ?>">View</button>
