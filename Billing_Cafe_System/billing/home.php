...
?>
<div class="container-fluid" style="padding:30px; background-color:white; margin-left:0%;" >
	<div class="row mt-3 ml-3 mr-3">
        <div class="col-lg-4">
           <div class="card" style="background-color:black;">
                <div class="card-header text-white">
                <span class="float:right"><a class="btn  btn-sm col-sm-3 float-right px-1" style="height: 30px; background-color:white" href="../index.php" id="">
            ...
            <form action="" id="manage-order">
                ...
                <div class="bg-white" id='o-list'>
                            <div class="d-flex w-100 mb-1 px-4" style="background-color:black;">
                                <label for="" class="text-white my-1 px-2" required><b>Order No:</b></label>
        ...
        <div class="col-lg-8  p-field">
            <div class="card">
                ...
                <div class="card-body d-flex" id='prod-list' style="background-color:black;">
                    <div class="col-md-3">
                        <div class="w-100 pr-0 bg-white" id="cat-list" style="height: 100%;">
                            <b style="font-family:cursive; padding-left:40px;">Category</b>
                            <hr>
                            <div class="card mx-3 mb-2 cat-item" style="height:auto !important; background-color:black;" data-id = 'all'>
                                <div class="card-body">
                            ...
                            ?>
                            <div class="card mx-3 mb-2 cat-item" style="height:auto !important; background-color:black;" data-id = '<?php echo $row['id'] ?>'>
                                <div class="card-body">
                                    <span><b class="text-white">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="card prod-item" style="background-color:white" data-json = '<?php echo json_encode($row) ?>' data-category-id="<?php echo $row['category_id'] ?>">
                                    <div class="card-body">
            ...
            <div class="card-footer border-light" style="background-color:black">
                <div class="row justify-content-center">
                    <div class="btn btn btn-sm col-sm-3 btn-light mr-2" type="button" id="pay">Pay</div>
                    <div class="btn btn btn-sm col-sm-3 btn-light" type="button" id="save_order">Pay later</div>
                </div>
            </div>
            </div>      			
        </div>
